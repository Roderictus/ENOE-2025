...
def procesar_profesiones_2_digitos_completo():
    # =========================================================================
    ...
    try:
        ...
        # =========================================================================
        # 3. DICCIONARIO COMPLETO (SINCO a 2 Dígitos + Faltantes Agregados)
        # =========================================================================
        cat_map_2d = {
        ...
        # Columnas que deben ser enteros (sin decimales)
        int_cols = [
            'Personas (Total Ocupados)',
            'Horas Mensuales Trabajadas',
            'Ingreso Mensual Promedio',
        ...
        # Columnas que deben mantener 1 decimal (porcentajes)
        pct_cols = [
            '% de la PEA Ocupada',
            '%Formal',
            '%Hombres',
        ...
        # Exportar CSV
        output_filename = "Grupos_Profesionales_Agregados_2D_Final.csv"
        df_res.to_csv(output_filename, index=False, encoding='utf-8-sig')
        
        print("\n¡Éxito! El archivo está listo y optimizado para Google Sheets.")
...
if __name__ == '__main__':
    procesar_profesiones_2_digitos_completo()